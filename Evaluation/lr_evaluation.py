"""
Linear Regression Model Evaluation Script
...
results_df = pd.read_csv('lr_results.csv')
...
metrics_df.to_csv('lr_evaluation_metrics.csv', index=False)
print(f"\n✅ Metrics saved to 'lr_evaluation_metrics.csv'")
...
fig.suptitle('Linear Regression Model Evaluation Dashboard', fontsize=16, fontweight='bold')

# Plot 1: Actual vs Predicted
axes[0, 0].scatter(y_actual, y_predicted, alpha=0.6, edgecolors='k', color='#4ECDC4')
...
axes[0, 1].hist(residuals, bins=15, edgecolor='black', alpha=0.7, color='#95E1D3')
...
axes[1, 0].scatter(y_predicted, residuals, alpha=0.6, edgecolors='k', color='#F38181')
...
plt.tight_layout()
plt.savefig('lr_evaluation_plots.png', dpi=300, bbox_inches='tight')
print(f"✅ Evaluation plots saved to 'lr_evaluation_plots.png'")
